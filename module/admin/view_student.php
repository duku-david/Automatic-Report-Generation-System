            ...
            <div class="form-group">
              ...
              <p id="gender_error" align="center"></p>
               ...
               <div class="form-group">     
                  ...
                  <p align="center" id="picture_error">(Only jpg,jpeg,png,jif image format allowed!)</p> 
...
<div class="formheadera">Number Of Students <span class="btn btn-info" style="border-radius: 200px; padding-left: 15px; padding-right: 15px;"><?php echo ($res_ct_arry['count_s'] + $res_ct_arry1['count_s']); ?></span> </div>
