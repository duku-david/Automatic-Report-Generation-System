              ...
              <div class="main-wrappings">
                    ...
                    <div class="Viewforms-container" >
                     ...
                     <div class="Viewforms">
                         ...
                         <a href="view_amarkA.php?c_id=<?php echo base64_encode("S5Science") ?>" style="float: left; margin-left: 20px; margin-top: 3px;" class="btn btn-primary">S 5 Science</a>
                     </div>
                      <div class="Viewforms">
                          
                         <a href="view_amarkA.php?c_id=<?php echo base64_encode("S5Art") ?>" style="float: left; margin-left: 20px; margin-top: 3px;" class="btn btn-primary">S 5 arts</a>
                     </div>
                      <div class="Viewforms">
                          
                         <a href="view_amarkA.php?c_id=<?php echo base64_encode("S6Science") ?>" style="float: left; margin-left: 20px; margin-top: 3px;" class="btn btn-primary">S 6 Science</a>
                     </div>
                      <div class="Viewforms">
                          
                         <a href="view_amarkA.php?c_id=<?php echo base64_encode("S6Art") ?>" style="float: left; margin-left: 20px; margin-top: 3px;" class="btn btn-primary">S 6 arts</a>
                     </div>
