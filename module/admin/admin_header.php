...
<body>
  <?php include'../../service/connection.php'; ?>
    <table class="headerTable" width="100%" cellspacing="0px" cellpadding="0px;">
        <tr>
          <td>
         <div class="topnav1" >
              <a href="index.php"  title="Home" class="btn btn-info" role="button">Home<i class="glyphicon glyphicon-home"></i></a>
                    ...
                    <a href="view_student.php" title="Student" class="btn btn-info" role="button">View Student<i class="glyphicon glyphicon-user"></i></a>
                     ...
                     <a href="viewSubject.php" title="Exam Schedule" class="btn btn-info" role="button">ViewSubjectTakenByTeacher<i class="glyphicon glyphicon-user"></i></a>
                     <a href="viewExamSchedule.php" title="Exam Schedule" class="btn btn-info" role="button">ViewExamTimeTable<i class="glyphicon glyphicon-user"></i></a>
                     <a href="viewAttendance.php" title="Attendance" class="btn btn-info" role="button">View Attendance<i class="glyphicon glyphicon-user"></i></a>
                     <!-- <a href="payment.php" title="Exam Schedule" class="btn btn-info" role="button">Payment<i class="glyphicon glyphicon-user"></i></a> -->
  ...
  <section>
      <div class="col-md5">
         <div id="admin_head"></div>
         <div class="left-float">
            <div class="image1">
               <img src="../image/pp.png" align="not found">
            </div>
              <div class="side-navi">
                 <a href="olevel.php">Register O level Student</a>
              </div>
              <div class="side-navi">
                 <a href="Alevel.php">Register A level Student</a>
              </div>
              <div class="side-navi">
                 <a href="staff.php">Register Staff</a>
              </div>
              <div class="side-navi">
                 <a href="report_setting.php">Report Setting</a>
              </div>
              <div class="side-navi">
                 <a href="change_pass.php">Change Password</a>
              </div>
               <div class="side-navi">
                 <a href="subject_registration.php">TeacherSubjectSelection</a>
              </div>
              <div class="side-navi">
                 <a href="createExamSchedule.php">Create Exam Time Table</a>
              </div>
              <div class="side-navi">
