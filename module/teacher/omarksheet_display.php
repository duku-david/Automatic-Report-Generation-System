...
<?php include('grade_action.php');?>
  ...
  <?php
       ...
       $queryt = "SELECT name FROM osubject WHERE sub_cod IN(SELECT sub_cod FROM subjecttakenbyteacher WHERE initials='".$initials."' AND c_id='".$c_id."' AND year='".$_SESSION['year']."')";
